                    ...
                    {cards.map((card, place) => {
                        ...
                        return (
                            <button
                                ...
                                className={cn(
                                    "relative isolate h-full shrink-0 cursor-pointer overflow-hidden bg-primary/5 p-0",
                    ...
                    return (
                        ...
                        >
                            <p className="max-w-[46rem] text-[15px] leading-[1.6] text-balance @lg:text-[17px]">
                                <span className="text-primary font-semibold">{slide.title}</span>{" "}
                                {slide.description && (
                                    <span className="text-primary/70">{slide.description}</span>
                                )}
                            </p>
