        ...
        >
          ...
          >
            ...
            <span className="relative inline-block">
              ...
              <svg className="absolute w-full h-3 -bottom-1 left-0 text-[#1351AA]/30" viewBox="0 0 100 10" preserveAspectRatio="none">
          ...
          >
            <div className="relative w-44 sm:w-52 aspect-[3/4]">
              <img
                ...
                className="w-full h-full object-cover object-center rounded-2xl border-2 border-[#0F172A]/15 shadow-xl"
              />
            </div>
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="mt-8 md:mt-10 flex flex-wrap items-center gap-4">
            <a 
              ...
              rel="noopener noreferrer"
              aria-label="GitHub"
              className="flex items-center justify-center w-12 h-12 rounded-xl border border-[#0F172A]/20 bg-white/70 text-[#0F172A] hover:text-white hover:bg-[#1351AA] hover:-translate-y-1.5 hover:shadow-md transition-all duration-300 shadow-sm"
            >
            ...
            <a 
              ...
              rel="noopener noreferrer"
              aria-label="LinkedIn"
              className="flex items-center justify-center w-12 h-12 rounded-xl border border-[#0F172A]/20 bg-white/70 text-[#0F172A] hover:text-[#0A66C2] hover:bg-[#0A66C2]/10 hover:border-[#0A66C2]/30 hover:-translate-y-1.5 hover:shadow-md transition-all duration-300 shadow-sm"
            >
            ...
            <a 
              ...
              className="flex items-center justify-center w-12 h-12 rounded-xl border border-[#0F172A]/20 bg-white/70 text-[#0F172A] hover:text-[#E4405F] hover:bg-[#E4405F]/10 hover:border-[#E4405F]/30 hover:-translate-y-1.5 hover:shadow-md transition-all duration-300 shadow-sm"
            >
          ...
          {/* Kolom Kanan — Foto khusus Desktop (>= lg) */}
          <motion.div
            variants={itemVariants}
            className="hidden lg:flex items-center justify-center"
            style={{ willChange: "transform, opacity" }}
          >
            <div className="relative w-full max-w-[380px] xl:max-w-[420px] aspect-[3/4]">
              <img
                src="/fotoAdzril.jpeg"
                alt="Adzril Ilham Ramadhan"
                className="w-full h-full object-cover object-center rounded-3xl border-2 border-[#0F172A]/15 shadow-2xl transition-transform duration-500 hover:scale-[1.01]"
              />
            </div>
          </motion.div>
